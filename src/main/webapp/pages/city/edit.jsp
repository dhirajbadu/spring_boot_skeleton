    ...
    <jsp:body>
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/city/list"><i class="fa fa-list"></i> Country List</a>
                </li>
                <li class="active"><i class="fa fa-plus-circle"></i>Edit City</li>
            </ol>
        </section>
        <!-- Main content -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="box">
                        ...
                        <form action="${pageContext.request.contextPath}/city/update" method="post" modelAttribute="city" autocomplete="off">
