...
<t:mainlayout title="token list">
    <jsp:body>
        <section class="content-header">
            <h1>
                Token List
                <small>All Token</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="${pageContext.request.contextPath}/dashboard"><i class="fa fa-dashboard"></i> Dashboard</a>
                </li>
                <li class="active"><i class="fa fa-users"></i> Token</li>
            </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <!-- /.box-header -->
                            <table id="ajaxUserTable" url="${pageContext.request.contextPath}/api/token/list" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Token</th>
