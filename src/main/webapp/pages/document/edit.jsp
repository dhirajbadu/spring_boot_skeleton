...
<t:mainlayout title="Edit Document">
    <jsp:body>
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/document/list"><i class="fa fa-list"></i> Document List</a>
                </li>
                <li class="active"><i class="fa fa-plus-circle"></i>Edit Document</li>
            </ol>
        </section>
        <!-- Main content -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="box">
                        ...
                        <form action="${pageContext.request.contextPath}/document/update" method="post" modelAttribute="document" autocomplete="off">
